...
APPS_DIR = ROOT_DIR.path("prizm_server")
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": [('ec2-13-125-217-213.ap-northeast-2.compute.amazonaws.com', 6379)],
        },
    },
}
...
LOCAL_APPS = [
    "prizm_server.users.apps.UsersConfig",
...
MIGRATION_MODULES = {"sites": "prizm_server.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "prizm_server.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Explabs""", "seungmin.kim@darlcha.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "prizm_server.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "prizm_server.users.adapters.SocialAccountAdapter"
