                        ...
                        <Fragment>
                            ...
                            {profile.custom_request_status.status === 'close' && (
                                <div className={`${styles.mb5} ${styles.pb5}`}>
                                    ...
                                    <div className={`${styles.widthFull} ${profile.is_verified ? styles.bgGray33 : styles.bgGray93} ${styles.row} ${styles.mx0} ${styles.mt6} ${styles.alignItemsCenter} ${styles.justifyContentCenter} ${styles.btn}`} style={{height: 48, maxWidth: 460}}>
                            ...
                            {profile.custom_request_status.status === 'open' && (
                                <div className={`${styles.mb5} ${styles.pb5}`}>
                                    ...
                                    <p className={`${styles.fontBold} ${styles.font14} ${styles.white}`}>{this.context.t("Proposals for ")}{profile.name}</p>
                                    </div>
