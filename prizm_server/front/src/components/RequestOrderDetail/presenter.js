                    ...
                    !requestSubmitted ? (
                        <Fragment>
                            ...
                            <div className={`${styles.px3}`}>
                                ...
                                {order.photographer.portfolio_url ? (
                                    <div className={`${styles.mt1} ${styles.row} ${styles.mx0} ${styles.alignItemsCenter} ${styles.justifyContentBetween}`}>
                                        <p className={`${styles.fontBold} ${styles.font12}`}>{this.context.t("Portfolio")}</p>
                                        <a href={order.photographer.portfolio_url} target={'_blank'} className={`${styles.font10} ${styles.black}`} style={{textDecoration: 'none'}}>{order.photographer.portfolio_url}</a>
                                    </div>
                                ) : (
                                    null
                                )}
