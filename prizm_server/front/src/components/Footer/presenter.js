...
const Footer = (props, context) => (
    <Fragment>
        <div className={`${styles.mobileNone}`}>
            <div className={`${styles.row} ${styles.mx0} ${styles.widthFull} ${styles.bgGray16} ${styles.px3} ${styles.py4} ${styles.alignItemsCenter}`}>
                ...
                <div className={`${styles.col12} ${styles.row} ${styles.mx0} ${styles.alignItemsCenter}`} style={{marginTop: 6}}>
        ...
        <div className={`${styles.mobileOnly}`}>
            <div className={`${styles.row} ${styles.mx0} ${styles.widthFull} ${styles.bgGray16} ${styles.px3} ${styles.py3} ${styles.alignItemsCenter}`}>
                ...
                <div className={`${styles.col12} ${styles.row} ${styles.mx0} ${styles.px0} ${styles.alignItemsCenter}`} style={{marginTop: 6}}>
