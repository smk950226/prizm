                        ...
                        !isConfirmPage ? (
                            <Fragment>
                                ...
                                <div className={`${styles.pt4} ${styles.px3} ${styles.mb3}`}>
                                    ...
                                    <div className={`${styles.widthFull} ${styles.bgGray16} ${styles.row} ${styles.mx0} ${styles.alignItemsCenter} ${styles.justifyContentCenter} ${styles.mt3} ${styles.btn}`} style={{height: 48}} onClick={this.props.goConfirm}>
